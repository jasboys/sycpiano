...
export const PlaySVG: React.FC<React.SVGProps<SVGSVGElement>> = ({ onMouseOver, onMouseOut, width, height, onClick, ...props }) => (
    <svg
        {...props}
        width={width}
        height={height}
...
export const SkipSVG: React.FC<React.SVGProps<SVGSVGElement>> = ({ onMouseOver, onMouseOut, width, height, onClick, ...props }) => (
    <svg
        {...props}
        width={width}
        height={height}
...
export const PauseSVG: React.FC<React.SVGProps<SVGSVGElement>> = ({ onMouseOver, onMouseOut, width, height, onClick, ...props }) => (
    <svg
        width={width}
        height={height}
        {...props}
