...
export const ShareIconSVG: React.FC<Record<never, unknown>> = () => {
    ...
    return (
        <svg style={{ display: 'none' }}>
            <title>Share Icon Template</title>
            <symbol id="share_icon_template" viewBox="-18 -18 36 36">
                ...
                <path
                    d={`M${xs[1]} ${ys[1]}L${xs[0]} ${ys[0]}L${xs[2]} ${ys[2]}`}
                    fill="none"
                />
            </symbol>
        </svg>
...
export const ShareIconInstance = React.forwardRef<
    SVGSVGElement,
...
>((props, ref) => (
    <svg
        ...
        viewBox="0 0 36 36"
    >
        <title>Share Icon Instance</title>
        <use
            href="#share_icon_template"
            width={props.width}
            height={props.height}
        />
    </svg>
