...
export const LinkIconSVG: React.FC<Record<never, unknown>> = () => (
    <svg style={{ display: 'none' }}>
        <title>Link Icon Template</title>
...
export const LinkIconInstance: React.FC<React.SVGProps<SVGSVGElement>> = (
    props,
) => (
    <svg
        {...props}
    ...
    >
        <title>Link Icon Instance</title>
