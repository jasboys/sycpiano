...
const Span = styled.span<{ focused: boolean }>(
    ...
    (props) => ({
        borderBottom: `1.2px solid ${
            props.focused ? lightBlue : unfocusedGray
        }`,
    }),
);

const Input = styled.input(latoFont(200), {
    flex: ' 1 1 auto',
    border: 'none',
    fontSize: '1.3rem',
    width: '100%',
...
export const Search: React.FC<SearchProps> = () => {
    ...
    const onReset = React.useCallback(
        (event: React.SyntheticEvent<HTMLDivElement>) => {
            ...
            if (match) {
                navigate(
                    (location.state?.last ?? '/schedule/upcoming') as string,
                );
            } else {
    ...
    const onSubmit = React.useCallback(
        (data: { search: string }) => {
            ...
            navigate(
                ...
                {
                    state:
                        location.pathname === '/schedule/search'
                            ? location.state
            ...
            >
                ...
                >
                    <InputGroup isMobile={screenXS || !!searchParams.get('q')}>
                        ...
                        <Label focused={focused} htmlFor="search">
                            Search
                        </Label>
                    </InputGroup>
                </Transition>
