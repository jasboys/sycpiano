...
const eventCollaboratorsStyle = css(latoFont(400), {
    listStyle: 'none',
    padding: 0,
    fontSize: '0.9rem',
...
export const EventCollaborators: React.FC<EventCollaboratorsProps> = ({
    collaborators,
}) => (
            ...
            (collaborator: Collaborator) =>
                ...
                collaborator.instrument && (
                    <div key={collaborator.name}>
                        ...
                        {' - '}
                        <span css={{ fontSize: '0.8em', fontWeight: 300 }}>
                            {startCase(collaborator.instrument)}
                        </span>
                    </div>
                ),
        )}
