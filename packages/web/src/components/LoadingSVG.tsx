...
export const LoadingInstance: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120">
        ...
        <circle id="loading-circle" cx="60" cy="60" r="59" />
        <image clipPath="url(#treble-mask)" x="0" y="0" height="120" width="120" xlinkHref="/static/images/loading-unmask.gif" />
    </svg>
);
